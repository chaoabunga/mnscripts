...
createconf() {
	...
	printf "%s\n" "rpcuser=$rpcuser" "rpcpassword=$rpcpass" "rpcallowip=127.0.0.1" "listen=1" "server=1" "daemon=1" "maxconnectons=256" "rpcport=4854" "externalip=$mnip" "bind=$mnip" "goldminenode=1" "goldminenodeprivkey=$MNPRIVKEY" "masternodeaddr=$mnip:4855" > $CONFDIR/$coin.conf
